...
class __TwigTemplate_1ae0f67d27081701b255577a5b511b863c4aca92a0c619c999caef9cbb9064a6 extends Template
{
    private $source;
    private $macros = [];
...
<table>
    <tr>
        ...
        echo "\"><i class=\"ti-control-skip-forward\"style=\"font-size: 50px;\"></i> </a></th>
                    ...
                    ";
        // line 107
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["f"]) || array_key_exists("f", $context) ? $context["f"] : (function () { throw new RuntimeError('Variable "f" does not exist.', 107, $this->source); })()), 'form_end');
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  228 => 107,  213 => 95,  209 => 94,  195 => 83,  191 => 82,  180 => 74,  176 => 73,  165 => 65,  161 => 64,  149 => 55,  145 => 54,  134 => 46,  130 => 45,  119 => 37,  115 => 36,  105 => 29,  101 => 28,  91 => 21,  87 => 20,  80 => 16,  68 => 6,  58 => 5,  35 => 1,);
    }
...
<table>
    <tr>
        ...
        <th> <a href=\"{{ path('display_activite') }}\"><i class=\"ti-control-skip-forward\"style=\"font-size: 50px;\"></i> </a></th>
    </tr>
</table>
